...
export function registrarTratamiento() {
    if (campos.nombreT && campos.precioVT && campos.precioCT) {
        guardarAccesorio();
...
export function cargarTabla(data) {
    ...
    tratamientos.forEach(function (tratamiento) {
        let registro =
                '<tr onclick="moduloTratamientos.seleccionarTratamiento(' + tratamientos.indexOf(tratamiento) + ');">' +
...
export function seleccionarTratamiento(index) {
...
export function borrarTratamiento() {
    Swal.fire({
